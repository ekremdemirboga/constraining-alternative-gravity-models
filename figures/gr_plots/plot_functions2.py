...
def dataReader3(directory):
    ...
    with open(directory) as f:
        ...
        return mass_ADM, radius, mass_ADM_stable1,radius_stable1,mass_ADM_stable2,radius_stable2,A_r,A_r_stable1,A_r_stable2
...
def plot2(directory,savedir=r"./", directoryGR=GR_dir_eos3, GR_on=1, Madm_R = 1):
    ...
    if (Madm_R==1):
        ...
        plt.ylabel(r"$M_{ADM} / M_{\odot}$",fontsize=20)
