...
datafiles1= ["MRprob_J0740_miller.txt","MRprob_J0740_riley.txt","MRprob_J0030_miller.txt","MRprob_J0030_riley.txt","MRprob_1608.dat","MRprob_1724.dat","MRprob_1731.dat", "MRprob_1745.dat", "MRprob_1748.dat", "MRprob_1820.dat"]
...
for relax_data in relaxation_data_eos3:
    ...
    if (PLOT_FLAG):
        ...
        plot(relax_data,prefix+"massless/"+Model+"/eos"+str(eos)+"/mr/",GR_dir)
    if(LIKELIHOOD_FLAG):
        ##Then Likelihood
